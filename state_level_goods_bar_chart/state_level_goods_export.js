...
d3.select('#dropdown_menu').select("#menu")
    .on('change', function () {
        ...
        create_bar_chart("2017", default_category, "#bar_chart_2017", "#pie1");
        create_bar_chart("2018", default_category, "#bar_chart_2018", "#pie2");
        create_bar_chart("2019", default_category, "#bar_chart_2019", "#pie3");
        create_bar_chart("2020", default_category, "#bar_chart_2020", "#pie4");
    });
...
function create_bar_chart(input_year, input_category, div, svg_id) {
